...
export { default as UserProfile, associate as associateUserProfile, init as initUserProfile } from './userprofile';
...
export { default as LocationDetails, associate as associateLocationDeayils, init as initLocationDetails } from './locationdetails';
